...
const HomePage = () => {
  ...
  return (
    <div className='min-h-screen'>
      <Navbar/>
      <div className=' lg:h-[557px] w-full bg-purple-800 flex justify-center items-center'>
        <div className='bg-white h-[800px] lg:h-[530px] w-[380px] lg:w-[900px] rounded-lg shadow flex'>
